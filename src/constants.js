...
// It also prevents the path starting with the string 'endpoints' and 'uptime' and 'templates' and 'template' as this is a reserved api path
exports.MIDDLEWARE_PATH_REGEX = /^(?!\/endpoints|\/uptime|\/templates|\/template)\/[\d\w-._~/:]+$/
